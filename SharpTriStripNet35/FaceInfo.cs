...
namespace SharpTriStripNet35
{
	...
	public class FaceInfo : IEquatable<FaceInfo>
	{
		...
		{
            unchecked // Permite desbordamiento de enteros
            {
                int hash = 17;
                hash = hash * 23 + this.V0.GetHashCode();
                hash = hash * 23 + this.V1.GetHashCode();
                hash = hash * 23 + this.V2.GetHashCode();
                hash = hash * 23 + this.StripID.GetHashCode();
                hash = hash * 23 + this.TestStripID.GetHashCode();
                hash = hash * 23 + this.ExperimentID.GetHashCode();
                hash = hash * 23 + this.IsFake.GetHashCode();
                return hash;
            }
        }
